...
FOSSIL_SUITE(c_cli_parser_challenges);

FOSSIL_SETUP(c_cli_parser_challenges) { }
FOSSIL_TEARDOWN(c_cli_parser_challenges) { }

// --------------------------------------
// Challenge 1: Create a Palette
// --------------------------------------
FOSSIL_TEST(c_test_create_palette) {
...
// --------------------------------------
FOSSIL_TEST(c_test_add_commands) {
...
// --------------------------------------
FOSSIL_TEST(c_test_add_arguments) {
...
// --------------------------------------
FOSSIL_TEST(c_test_combo_argument) {
...
// --------------------------------------
FOSSIL_TEST(c_test_parse_boolean_flag) {
...
// --------------------------------------
FOSSIL_TEST(c_test_parse_string_and_numbers) {
...
// --------------------------------------
FOSSIL_TEST(c_test_invalid_arguments) {
...
// --------------------------------------
FOSSIL_TEST(c_test_parse_date_argument) {
...
// --------------------------------------
FOSSIL_TEST(c_test_feature_flags) {
...
// --------------------------------------
FOSSIL_TEST(c_test_free_palette) {
...
// --------------------------------------
FOSSIL_TEST_GROUP(c_cli_parser_tests) {
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_create_palette);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_add_commands);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_add_arguments);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_combo_argument);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_parse_boolean_flag);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_parse_string_and_numbers);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_invalid_arguments);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_parse_date_argument);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_feature_flags);
    FOSSIL_TEST_ADD(c_cli_parser_challenges, c_test_free_palette);

    FOSSIL_TEST_REGISTER(c_cli_parser_challenges);
}
