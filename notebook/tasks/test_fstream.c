...
FOSSIL_SUITE(c_fstream_challenges);

FOSSIL_SETUP(c_fstream_challenges) { }
FOSSIL_TEARDOWN(c_fstream_challenges) { }

// --------------------------------------
// Challenge 1: Open and Close Stream
// --------------------------------------
FOSSIL_TEST(c_test_fstream_open_close) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_write_read) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_append) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_seek_tell) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_redirect_devnull) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_copy_save) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_delete_rename) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_permissions) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_tempfile) {
...
// --------------------------------------
FOSSIL_TEST(c_test_fstream_full_pipeline) {
...
// Register All Tests
// --------------------------------------
FOSSIL_TEST_GROUP(c_fstream_tests) {
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_open_close);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_write_read);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_append);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_seek_tell);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_redirect_devnull);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_copy_save);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_delete_rename);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_permissions);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_tempfile);
    FOSSIL_TEST_ADD(c_fstream_challenges, c_test_fstream_full_pipeline);

    FOSSIL_TEST_REGISTER(c_fstream_challenges);
}
