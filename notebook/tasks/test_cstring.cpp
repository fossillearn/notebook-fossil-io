...
// Setup / Teardown
FOSSIL_SETUP(cpp_cstring_challenges) {}
FOSSIL_TEARDOWN(cpp_cstring_challenges) {}
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_money_conversion) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_money_conversion_currency) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_token) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_case_functions) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_novelty_transforms) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_sub_reverse_contains) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_safe_operations) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_stream) {
...
// --------------------------------------
FOSSIL_TEST(cpp_test_cstring_json_normalize) {
